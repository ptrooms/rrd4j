...
public class UtilTest {
    ...
    public void testGetCalendar(){
        ...
        Calendar calendar4 = Util.getCalendar("2019-01-02 03:04:05");			// summer/winter time falure
        Assert.assertEquals(1_546_394_645_000L, calendar4.getTime().getTime());   // ptrooms: (error: 1_546_398_245_000)
    }
    ...
    public void testGetTimestamp() {
        ...
        Assert.assertEquals(1549_073_040L, Util.getTimestamp(2019, 1, 2, 3, 4));  // ptrooms: (error:1_549_076_640L)

        Assert.assertEquals(1_549_062_000L, Util.getTimestamp(2019, 1, 2)); // ptrooms: (error : 1_549_065_600L)
    }
